...
/usr/bin/yq e ".resources[0].properties.autoscalers[0].autoScalingPolicy.minNumReplicas = <SCALING MIN>" -i $config_file
/usr/bin/yq e ".resources[0].properties.autoscalers[0].autoScalingPolicy.maxNumReplicas = <SCALING MAX>" -i $config_file
/usr/bin/yq e ".resources[0].properties.autoscalers[0].autoScalingPolicy.cpuUtilization.utilizationTarget = <SCALING UTILIZATION TARGET>" -i $config_file
/usr/bin/yq e ".resources[0].properties.autoscalers[0].autoScalingPolicy.coolDownPeriodSec = <SCALING COOL DOWN PERIOD>" -i $config_file
/usr/bin/yq e ".resources[0].properties.autoscalers[0].zone = \"<AVAILABILITY ZONE>\"" -i $config_file
/usr/bin/yq e ".resources[0].properties.autoscalers[0].name = \"bigip\"" -i $config_file
/usr/bin/yq e ".resources[0].properties.imageName = \"<IMAGE NAME>\"" -i $config_file
/usr/bin/yq e ".resources[0].properties.instanceGroupManagers[0].zone = \"<AVAILABILITY ZONE>\"" -i $config_file
/usr/bin/yq e ".resources[0].properties.instanceGroupManagers[0].name = \"bigip\"" -i $config_file
/usr/bin/yq e ".resources[0].properties.instanceTemplates[0].hostname = \"<HOST NAME>\"" -i $config_file
/usr/bin/yq e ".resources[0].properties.instanceTemplates[0].name = \"bigip\"" -i $config_file
...
/usr/bin/yq e ".resources[0].properties.healthChecks[0].httpHealthCheck.port = 80" -i $config_file
/usr/bin/yq e ".resources[0].properties.healthChecks[0].httpHealthCheck.type = \"HTTP\"" -i $config_file
/usr/bin/yq e ".resources[0].properties.healthChecks[0].name = \"<UNIQUESTRING>-external-hc\"" -i $config_file
...
/usr/bin/yq e ".resources[0].properties.targetPools[0].region = \"<REGION>\"" -i $config_file
/usr/bin/yq e ".resources[0].properties.targetPools[0].name = \"bigip\"" -i $config_file
