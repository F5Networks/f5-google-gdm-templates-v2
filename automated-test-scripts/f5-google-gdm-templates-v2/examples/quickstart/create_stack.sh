...
/usr/bin/yq e ".resources[0].properties.bigIpCustomImageId = \"f5-7626-networks-public/global/images/f5-bigip-16-1-3-1-0-0-11-payg-best-plus-25mbps-220721054250\"" -i ${tmpl_path}<DEWPOINT JOB ID>.yaml
