...
config_file='f5-google-gdm-templates-v2-main/examples/failover/<DEWPOINT JOB ID>.yaml'

if echo "<TEMPLATE URL>" | grep -q "existing-network"; then
    echo "Using existing network"
    cp f5-google-gdm-templates-v2-main/examples/failover/sample_failover_existing_network.yaml $config_file
    ...
    cp f5-google-gdm-templates-v2-main/examples/failover/sample_failover.yaml $config_file
